...
namespace TowerDefence
{
    public class GameManager : MonoBehaviour
    {
        ...
        public GameObject magicalShopWindow;
        ...
        public void SetBuildTarget(BuildNode _target)
        {
            ...
            else if(_target.isMagicalNode)
            {
                ShowMagicalShopWindow();    
            }
            else
            {
                ShowShopWindow();
        ...
        public void ShowMagicalUI(BuildNode _target)
        {
            Debug.Log("Ismagi2");
            selectedBuildNode = _target;
           // selectedBuildNode.towerScript.ShowRangeUI();
        ...
        public void CloseAllWindowsButton()
        {
            ...
            magicalShopWindow.SetActive(false); 
        ...
        private void ShowMagicalShopWindow()
        {
            magicalShopWindow.SetActive(true);
        }
