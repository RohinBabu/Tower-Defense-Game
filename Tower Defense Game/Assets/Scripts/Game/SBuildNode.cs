...
{
    public class SBuildNode : MonoBehaviour
    {
        ...
        public Vector3 GetSBuildPosition()
        {
        ...
        public void UpgradeTurret01()
        {
            ...
            //}
            GameObject _stower = Instantiate(towerBlueprint.upgrade02.towerPrefab, GetSBuildPosition(), Quaternion.identity);
            tower = _stower;
            towerScript = _stower.GetComponent<Tower>();
